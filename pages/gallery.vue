<template>
  <div class="flex flex-wrap gap-12">
    <div @click="open" ref="image"
      class="w-[150px] banner-img cursor-pointer border-2 rounded p-2 flex flex-col items-center justify-center bg-blue-500">

      <img src="@/assets/images/kimi.jpeg" />
      <p class="capitalize text-lg">Senna</p>
    </div>
  </div>
</template>
...
function open() {
  (document as any).startViewTransition(() => {
    if (image.value.classList.contains('w-full')) {
